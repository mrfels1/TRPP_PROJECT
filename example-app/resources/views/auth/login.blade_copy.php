            ...
            <div class="inputs">
                ...
                <div>
                    <div class="input">
                        ...
                        <input class="input_field" id="email" type="email" name="email" required="required" autofocus="autofocus" autocomplete="username">
                ...
                <div class="input">
                    ...
                    <input class="input_field" id="password" type="password" name="password" required="required" autofocus="autofocus" autocomplete="current-password">
