...
<link href="{{ asset('css/CreatePostStyle.css') }}" rel="stylesheet">
@extends ('layout')
...
<form method="POST" action="{{ route('post.store') }}">
    ...
    <!-- Title -->
        ...
        <!-- <input id="title"  placeholder="Title" class="content-input block mt-1 w-full" type="text" name="title" :value="old('title')" required
            ...
            <input id="title"  placeholder="Title" class="content-input" type="text" name="title" :value="old('title')" required
            autofocus />  </div>
    ...
    <!-- Tags -->
        ...
        <!-- <input id="tags" placeholder="Tags"  class="content-input block mt-1 w-full" type="text" name="tags" :value="old('tags')" required
            autofocus /> -->
        <div class="input-container">
        <input id="tags" placeholder="Tags"  class="content-input" type="text" name="tags" :value="old('tags')" required
            autofocus />    </div>
    ...
    <!-- Text -->
        ...
        <!-- <x-text-input id="text_content" placeholder="Text" class="content-input block mt-1 w-full" type="text" name="text_content"
            ...
            :value="old('text_content')" required autofocus />    </div>
